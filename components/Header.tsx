...
import { LogoFill } from '@my/assets/LogoFill';
                  ...
                  <div className="hidden space-x-5 sm:flex">
                     {headerNavLinks.map(({ title }) => (
                        <button
                           ...
                           onClick={() => {}}
                           key={title}
                           className="basic-text py-1 after:bg-black dark:after:bg-white underline-animation text-md font-semibold dark:text-white text-slate-900"
                           aria-label={title}
                        >
